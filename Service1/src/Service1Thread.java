...
public class Service1Thread extends Thread {
    ...
    public Service1Thread(Socket socket, Service1ToAgentConnectionThread serviceToAgentConnectionThread,
            LinkedList<String> responses, int myPort, int serviceInstance, ArrayList<Service1Thread> threads)
            throws IOException {
    ...
    public void run() {
            ...
            while (!isInterrupted()) {
                ...
                serviceToAgentConnectionThread.addRequestToAgent(
                        "type:process_data;message_id:" + decodedData[1].split(":")[1]
                                + ";sub_type:Service_to_agent;source_name:Service1;service_instance_id:"
                                + serviceInstance + "");
        ...
        System.out.println("Service1 -> Handle the closing procedure.");
