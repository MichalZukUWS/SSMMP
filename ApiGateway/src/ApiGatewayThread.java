        ...
        try {
            while (true) {
                ...
                if (serviceNameNowConnected == null) {
                    ...
                    String dataToAgent = "type:session_request;message_id:" + decodedData[1].split(":")[1]
                    ...
                    servicePortNowConnected = Integer.parseInt(response.split(";")[5].split(":")[1]);
                    ...
                    if (!serviceNameNowConnected.equals(decodedData[0].split(":")[1])) {
                        ...
                        String dataToAgent = "type:source_service_session_close_info;message_id:"
                                ...
                                + ";dest_service_instance_network_address:localhost_" + servicePortNowConnected
                        ...
                        serviceNameNowConnected = decodedData[0].split(":")[1];
                        dataToAgent = "type:session_request;message_id:" + decodedData[1].split(":")[1]
                                + ";sub_type:service_to_agent;source_service_name:Api Gateway;source_service_instance_id:100;source_plug_name:P;dest_service_name:";
